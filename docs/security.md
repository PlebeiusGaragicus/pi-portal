...
- Operations are constrained to the configured **dot-mi root** (`DOT_MI_DIR` / `DOT_MI_ROOT`).
- New extension and skill symlinks use only the **relative** targets documented for dot-mi (`../../../shared/extensions/…`, `../../../shared/skills/…`), and targets must exist under `shared/`.
